...
const { UserBot, Conversation, Message, Client } = require('./bot/models/models');
...
//----------------------------------------------------------------------------------------------------------------
                ...
                socket.emit("sendMessageCustomer", {
                    senderId: chatId,
...
const start = async () => {
    try {
        ...
        httpsServer.listen(PORT, async() => {
            console.log('HTTPS Server BotCustomer running on port ' + PORT);
